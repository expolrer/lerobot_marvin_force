...
from .forcevla.configuration_forcevla import ForceVLAConfig
from .gaussian_actor.configuration_gaussian_actor import GaussianActorConfig
from .groot.configuration_groot import GrootConfig
from .implicitrdp.configuration_implicitrdp import ImplicitRDPConfig
from .lingbot_va.configuration_lingbot_va import LingBotVAConfig
from .molmoact2.configuration_molmoact2 import MolmoAct2Config
from .multi_task_dit.configuration_multi_task_dit import MultiTaskDiTConfig
from .pi0.configuration_pi0 import PI0Config
from .pi05.configuration_pi05 import PI05Config
from .rdp.configuration_rdp import RDPConfig
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from .forcevla.modeling_forcevla import ForceVLAPolicy

        return ForceVLAPolicy
    elif name == "rdp":
        from .rdp.modeling_rdp import RDPPolicy

        return RDPPolicy
    elif name == "implicitrdp":
        from .implicitrdp.modeling_implicitrdp import ImplicitRDPPolicy

        return ImplicitRDPPolicy
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "forcevla":
        return ForceVLAConfig(**kwargs)
    elif policy_type == "rdp":
        return RDPConfig(**kwargs)
    elif policy_type == "implicitrdp":
        return ImplicitRDPConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, RDPConfig):
        from .rdp.processor_rdp import make_rdp_pre_post_processors

        processors = make_rdp_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
