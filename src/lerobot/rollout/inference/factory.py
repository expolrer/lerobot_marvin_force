...
from .rdp import RDPInferenceEngine
...
@InferenceEngineConfig.register_subclass("rdp")
@dataclass
class RDPInferenceConfig(InferenceEngineConfig):
    """RDP slow planner plus per-tick force-conditioned decoder."""
...
def create_inference_engine(
    ...
    *,
    ...
    if isinstance(config, RDPInferenceConfig):
        return RDPInferenceEngine(
            policy=policy,
            preprocessor=preprocessor,
            postprocessor=postprocessor,
            dataset_features=dataset_features,
